...
public record IssueDetailDTO(String id, String title, String author, LocalDate creationDate, IssueStatusDTO status, IssueModelInfoDTO model, List<IssueFieldDTO> fields) { }
