...
public record IssueDetailDTO(String id, String title, String author, LocalDate createdAt, CategoryDTO category, IssueStatusDTO status, IssueModelShortDTO model, List<IssueFieldDTO> fields, List<CommentDTO> comments) { }
